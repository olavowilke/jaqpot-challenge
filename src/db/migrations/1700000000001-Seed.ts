...
export class Seed1700000000001 implements MigrationInterface {
  ...
  public async down(q: QueryRunner): Promise<void> {
    await q.query(`DELETE FROM provider_games WHERE id = '55555555-5555-5555-5555-555555555555'`);
    await q.query(`DELETE FROM casino_games WHERE id = '44444444-4444-4444-4444-444444444444'`);
    await q.query(`DELETE FROM casino_game_providers WHERE id = '33333333-3333-3333-3333-333333333333'`);
    await q.query(`DELETE FROM casino_wallets WHERE id = '22222222-2222-2222-2222-222222222222'`);
    await q.query(`DELETE FROM casino_users WHERE id = '11111111-1111-1111-1111-111111111111'`);
  }
}
